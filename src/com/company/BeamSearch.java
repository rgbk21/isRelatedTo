...
//    LinkedList<SearchNode> fringe   = new LinkedList<SearchNode>();
    ...
    ArrayList<HyperLink> Edges = new ArrayList<>();

//    ArrayList<HyperLink> Edges = new ArrayList<>(Comparator.comparing(HyperLink::getHValue));
    ...
    public void BeamSearch(){
        ...
        while(fringe.peek() != null) {
            ...
            HyperLink maxHValueEdge = Edges.remove(0);
            Edges.sort(Comparator.comparing(HyperLink::getHValue));
            ...
            while (true)
            {
                ...
                if ( ! alreadyAdded.contains(tempString) )
                {
                    ...
                    if(Edges.size() < 20) {
                        ...
                        if(Edges.get(beamWidth-1).getHValue() > newEdge.getHValue()){
                            Edges.remove(beamWidth-1);
                            Edges.add(newEdge);
                            Edges.sort(Comparator.comparing(HyperLink::getHValue));
                        }
                    }
